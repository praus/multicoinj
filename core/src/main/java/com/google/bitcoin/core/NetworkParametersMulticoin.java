 ...
 */
public class NetworkParametersMulticoin extends NetworkParameters {
    ...
    public static final String ID_MULTICOIN = "org.bitcoin.multicoin";
    ...
    private static NetworkParametersMulticoin createTestNet3(NetworkParametersMulticoin n) {
    ...
    private static NetworkParametersMulticoin createOldTestNet(NetworkParametersMulticoin n) {
    ...
    public static NetworkParameters testNet2() {
    	NetworkParametersMulticoin n = new NetworkParametersMulticoin();
    ...
    private static Block createMultiGenesis(NetworkParameters n) {
      Block genesisBlock = new Block(n);
      Transaction t = new Transaction(n);
      String pszTimestamp = "Power to the lolcats!";
      try {
          // A script containing the difficulty bits and the following message:
          //
          //   "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks"
...
//                  ("04ffff001d0104455468652054696d65732030332f4a616e2f32303039204368616e63656c6c6f72206f6e206272696e6b206f66207365636f6e64206261696c6f757420666f722062616e6b73");
          ...
          scriptSig.write(486604799);
          Long extraNonce = 2L;
          scriptSig.write(longToBytes(extraNonce));
          scriptSig.write(pszTimestamp.getBytes());
          t.addInput(new TransactionInput(n, t, scriptSig.toByteArray()));
          
          ByteArrayOutputStream scriptPubKeyBytes = new ByteArrayOutputStream();
          scriptPubKeyBytes.write(Script.OP_DUP);
          scriptPubKeyBytes.write(Script.OP_HASH160);
          Script.writeBytes(scriptPubKeyBytes, Hex.decode("13sYEQsebjPeFwNR1QETkuKU6HZZQxu4cV"));
          scriptPubKeyBytes.write(Script.OP_EQUALVERIFY);
          scriptPubKeyBytes.write(Script.OP_CHECKSIG);
...
//        return genesisBlock;
    ...
    public static NetworkParametersMulticoin multiNet() {
    	NetworkParametersMulticoin n = new NetworkParametersMulticoin();
        n.proofOfWorkLimit = Utils.decodeCompactBits(0x1d00ffffL);
        n.port = 8333;
        n.packetMagic = 0xf9beb4d9L;
...
//        n.genesisBlock = createMultiGenesis(n);
//        n.genesisBlock.setDifficultyTarget(0x1d00ffffL);
//        n.genesisBlock.setTime(1346303453L);
//        n.genesisBlock.setNonce(1494501650);
        n.setSpendableCoinbaseDepth(100);
        n.setSubsidyDecreaseBlockCount(210000);
        n.id = ID_MULTICOIN;
        n.allowEmptyPeerChains = false;
        String genesisHash = n.genesisBlock.getHashAsString();
        System.out.println("Multicoin genesis: "+genesisHash);
//        checkState(genesisHash.equals("000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"),
//                genesisHash);
